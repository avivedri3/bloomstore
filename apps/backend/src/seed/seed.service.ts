...
const CATALOG: Array<{
  ...
  {
    name: 'Garden Yellow Roses',
    description: 'A dozen sunny garden roses with salal — cheerful and classic.',
    category: 'roses',
    price: 168,
    stock: 17,
    imageUrl: unsplash('photo-1490750967868-88aa4486c946'),
    isActive: true,
  },
  {
    name: 'Peach Garden Roses',
    description: 'Honey-peach roses with spray buds, wrapped in tissue.',
    category: 'roses',
    price: 182,
    stock: 12,
  ...
  {
    name: 'Dutch Tulip Bunch',
    description: 'Seasonal tulips in mixed pastels, cut short for a vase.',
    category: 'seasonal',
    price: 145,
    stock: 20,
  ...
  {
    name: 'Sunflower Market Bunch',
    description: 'Tall sunflowers with ruscus — a late-summer market classic.',
    category: 'seasonal',
    price: 135,
    stock: 15,
  ...
  },
  {
    ...
    description: 'Sculptural spring branches for a tall vase or entry table.',
    category: 'seasonal',
    price: 189,
    stock: 8,
    imageUrl: unsplash('photo-1522383225653-ed111181a951'),
    isActive: true,
  },
  {
    name: 'Provence Lavender Sheaf',
    description: 'Dried lavender tied with twine — fragrant and long-lasting.',
    category: 'seasonal',
    price: 95,
    stock: 21,
    imageUrl: pexels('1083822/pexels-photo-1083822.jpeg'),
    isActive: true,
  },
  {
    name: 'Hydrangea Cloud Bouquet',
    description: 'Full mophead hydrangea in blush and cream.',
    category: 'bouquets',
    price: 175,
    stock: 10,
  ...
  {
    name: 'Coral Peony Bouquet',
    description: 'Coral Charm peonies with a few garden roses — peak-season only.',
    category: 'bouquets',
    price: 198,
    stock: 9,
    imageUrl: pexels('931176/pexels-photo-931176.jpeg'),
    isActive: true,
  },
  {
    name: 'Ranunculus & Sweet Pea',
    description: 'Layered ranunculus with trailing sweet pea for a garden look.',
    category: 'bouquets',
    price: 162,
    stock: 14,
    imageUrl: unsplash('photo-1519378058457-4c29a0a2efac'),
    isActive: true,
  },
  {
    name: 'Wild Garden Hand-Tied',
    description: 'A loose, florist-style mix of seasonal stems and trailing greenery.',
    category: 'bouquets',
    price: 158,
    stock: 11,
    imageUrl: pexels('1231265/pexels-photo-1231265.jpeg'),
    isActive: true,
  },
  {
    name: 'White Hydrangea Centerpiece',
    description: 'Low bowl of white hydrangea for head tables and dinners.',
    category: 'weddings',
    price: 310,
    stock: 5,
    imageUrl: pexels('169190/pexels-photo-169190.jpeg'),
    isActive: true,
  },
  {
    name: 'Bridesmaid Posy',
    description: 'Compact posy of roses and spray blooms to match the cascade.',
    category: 'weddings',
    price: 145,
    stock: 12,
  ...
  {
    name: 'Dried Flower Boutonniere',
    description: 'A single dried bloom with olive leaf and silk wrap.',
    category: 'weddings',
    price: 65,
    stock: 18,
    imageUrl: unsplash('photo-1462275646964-a0e3386b89fa'),
    isActive: true,
  },
  {
    name: 'Fiddle Leaf Fig',
    description: 'Indoor Ficus lyrata in a tall planter — a living statement piece.',
    category: 'plants',
    price: 149,
    stock: 7,
  ...
  },
  {
    ...
    description: 'A blooming moth orchid in a ceramic cachepot.',
    category: 'plants',
    price: 119,
    stock: 11,
  ...
  {
    name: 'Snake Plant',
    description: 'Hardy Sansevieria in a matte pot — low light, low fuss.',
    category: 'plants',
    price: 89,
    stock: 16,
  ...
  {
    name: 'Olive Tree in Terracotta',
    description: 'A small olive tree for a sunny balcony or kitchen.',
    category: 'plants',
    price: 159,
    stock: 6,
  ...
  {
    name: 'White Callas Standing Spray',
    description: 'Tall calla lilies with eucalyptus for a memorial service.',
    category: 'sympathy',
    price: 225,
    stock: 5,
  ...
  {
    name: 'Soft Ivory Basket',
    description: 'Ivory roses and spray chrysanthemums in a handled basket.',
    category: 'sympathy',
    price: 185,
    stock: 7,
    imageUrl: unsplash('photo-1606041008023-472dfb5e530f'),
    isActive: true,
  },
  {

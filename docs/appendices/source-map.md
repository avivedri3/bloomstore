...
| --- | --- | --- |
| שער, הצהרה, 1.2 | שם, ת״ז, מכללה, מסלול, מנחה, טלפון מגיש (`050-5806570`), טלפון מנחה (`052-8612379`), חלוקת אחריות | `docs/student-qa-appendix.md` |
...
| 6 | ניהול, וסדר פעולות ההזדהות בסעיף 6.2 | `products.controller.ts`, `products.service.ts`, `orders.controller.ts`, `analytics.service.ts`, `auth/admin.guard.ts`, `auth/auth.controller.ts`, `auth/auth.service.ts` |

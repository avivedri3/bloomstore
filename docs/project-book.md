...
תודה למנחה הפרויקט, מור ברגיג, על הליווי לאורך שלבי הפיתוח. תודה למכללת אורט סינגאלובסקי על המסגרת ועל דרישות ספר הפרויקט. תודה לקהילת הקוד הפתוח, שהספריות והתיעוד שלה הם הבסיס שעליו נבנתה המערכת. תודה למשפחה ולחברים על הסבלנות ועל התמיכה.
